...
export class AppComponent {
  ...
  constructor(private router: Router) {
    ...
    this.router.events.pipe(
      ...
      || event.url === '/profil'|| event.url.startsWith('/conversation') || event.url === '/edit-profile'|| event.url.startsWith('/post-details') || event.url.startsWith('/search-results') || event.url.startsWith('/my-posts')  );
    });
  }
